...
export const Banner = () => {
   ...
   const toRotate = ["A Web Developer", " A Business Analyst", " A Data Analyst", " An Entreprenur/Starup Founder","Recruiting & HR Professironal ", "And a Research & Innovation Strategist"];
   const period = 2000;
